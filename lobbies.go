...
func newLobbies(sdkConfig sdkConfiguration) *Lobbies {
	return &Lobbies{
		sdkConfiguration: sdkConfig,
	}
}

// CreatePrivate - CreatePrivateLobby
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Lobbies) CreatePrivate(ctx context.Context, security operations.CreatePrivateLobbySecurity, requestBody operations.CreatePrivateLobbyRequestBody, appID *string, roomID *string, opts ...operations.Option) (*components.Lobby, error) {
...
// CreatePublic - CreatePublicLobby
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Lobbies) CreatePublic(ctx context.Context, security operations.CreatePublicLobbySecurity, requestBody operations.CreatePublicLobbyRequestBody, appID *string, roomID *string, opts ...operations.Option) (*components.Lobby, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// CreateLocal - CreateLocalLobby
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Lobbies) CreateLocal(ctx context.Context, security operations.CreateLocalLobbySecurity, requestBody operations.CreateLocalLobbyRequestBody, appID *string, roomID *string, opts ...operations.Option) (*components.Lobby, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// ListActivePublic - ListActivePublicLobbiesDeprecatedV2
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Lobbies) ListActivePublic(ctx context.Context, appID *string, region *components.Region, opts ...operations.Option) ([]components.Lobby, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// SetState - SetLobbyState
// Set the state of a lobby. State is intended to be set by the server and must be smaller than 1MB. Use this endpoint to store match data like live player count to enforce max number of clients or persist end-game data (i.e. winner or final scores).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Lobbies) SetState(ctx context.Context, roomID string, setLobbyStateParams components.SetLobbyStateParams, appID *string, opts ...operations.Option) (*components.Lobby, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Lobbies) Create(ctx context.Context, security operations.CreateLobbySecurity, createLobbyV3Params components.CreateLobbyV3Params, appID *string, shortCode *string, roomID *string, opts ...operations.Option) (*components.LobbyV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// ListPublic - ListActivePublicLobbies
...
func (s *Lobbies) ListPublic(ctx context.Context, appID *string, region *components.Region, opts ...operations.Option) ([]components.LobbyV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetInfoByRoomID - GetLobbyInfoByRoomId
// Get details for a lobby.
func (s *Lobbies) GetInfoByRoomID(ctx context.Context, roomID string, appID *string, opts ...operations.Option) (*components.LobbyV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetByShortCode - GetLobbyInfoByShortCode
...
func (s *Lobbies) GetByShortCode(ctx context.Context, shortCode string, appID *string, opts ...operations.Option) (*components.LobbyV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
