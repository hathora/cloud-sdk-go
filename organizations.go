...
func (s *Organizations) Get(ctx context.Context, opts ...operations.Option) (*components.OrgsPage, error) {
...
func (s *Organizations) GetUserPendingInvites(ctx context.Context, opts ...operations.Option) (*components.PendingOrgInvitesPage, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetMembers - GetOrgMembers
func (s *Organizations) GetMembers(ctx context.Context, orgID string, opts ...operations.Option) (*components.OrgMembersPage, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// InviteUser
func (s *Organizations) InviteUser(ctx context.Context, orgID string, createUserInvite components.CreateUserInvite, opts ...operations.Option) (*components.PendingOrgInvite, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// RescindInvite
func (s *Organizations) RescindInvite(ctx context.Context, orgID string, rescindUserInvite components.RescindUserInvite, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetUsageLimits
func (s *Organizations) GetUsageLimits(ctx context.Context, orgID *string, opts ...operations.Option) (*components.UsageLimits, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
