...
// GetPendingInvites - GetOrgPendingInvites
func (s *OrganizationsV1) GetPendingInvites(ctx context.Context, orgID string, opts ...operations.Option) (*components.PendingOrgInvitesPage, error) {
