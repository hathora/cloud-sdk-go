...
// GetLatestDeprecated - GetLatestDeploymentV1Deprecated
// Get the latest [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment) for an [application](https://hathora.dev/docs/concepts/hathora-entities#application).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *DeploymentsV1) GetLatestDeprecated(ctx context.Context, appID *string, opts ...operations.Option) (*components.DeploymentV1, error) {
...
// GetInfo - GetDeploymentInfoV1Deprecated
// Get details for a [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *DeploymentsV1) GetInfo(ctx context.Context, deploymentID int, appID *string, opts ...operations.Option) (*components.DeploymentV1, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
