...
// GetActiveForProcessDeprecated - GetActiveRoomsForProcessDeprecated
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *RoomsV1) GetActiveForProcessDeprecated(ctx context.Context, processID string, appID *string, opts ...operations.Option) ([]components.RoomWithoutAllocations, error) {
...
// DestroyDeprecated - DestroyRoomDeprecated
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *RoomsV1) DestroyDeprecated(ctx context.Context, roomID string, appID *string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
