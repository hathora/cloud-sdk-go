...
// GetPingEndpoints - GetPingServiceEndpointsDeprecated
...
func (s *Discovery) GetPingEndpoints(ctx context.Context, opts ...operations.Option) ([]components.PingEndpoints, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []components.PingEndpoints
