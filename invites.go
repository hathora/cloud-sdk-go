...
// Update - UpdateUserInvite
func (s *Invites) Update(ctx context.Context, orgID string, updateUserInvite components.UpdateUserInvite, opts ...operations.Option) (*bool, error) {
...
// Reject - RejectInvite
func (s *Invites) Reject(ctx context.Context, orgID string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
