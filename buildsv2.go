...
// GetInfo - GetBuildInfoV2Deprecated
// Get details for a [build](https://hathora.dev/docs/concepts/hathora-entities#build).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *BuildsV2) GetInfo(ctx context.Context, buildID int, appID *string, opts ...operations.Option) (*components.Build, error) {
...
// RunDeprecated - RunBuildV2Deprecated
// Builds a game server artifact from a tarball you provide. Pass in the `buildId` generated from [`CreateBuild()`](https://hathora.dev/api#tag/BuildV1/operation/CreateBuild).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *BuildsV2) RunDeprecated(ctx context.Context, buildID int, requestBody operations.RunBuildV2DeprecatedRequestBody, appID *string, opts ...operations.Option) (io.ReadCloser, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
