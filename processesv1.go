...
func newProcessesV1(sdkConfig sdkConfiguration) *ProcessesV1 {
	return &ProcessesV1{
		sdkConfiguration: sdkConfig,
	}
}

// GetInfo - GetProcessInfoDeprecated
// Get details for a [process](https://hathora.dev/docs/concepts/hathora-entities#process).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *ProcessesV1) GetInfo(ctx context.Context, processID string, appID *string, opts ...operations.Option) (*components.Process, error) {
