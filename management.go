...
func newManagement(sdkConfig sdkConfiguration) *Management {
	return &Management{
...
func (s *Management) SendVerificationEmail(ctx context.Context, request components.VerificationEmailRequest, opts ...operations.Option) (*components.VerificationEmailSuccess, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/management/v1/sendverificationemail")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.VerificationEmailSuccess
