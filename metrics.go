...
// GetProcessMetrics - GetMetricsDeprecated
// Get metrics for a [process](https://hathora.dev/docs/concepts/hathora-entities#process) using `appId` and `processId`.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Metrics) GetProcessMetrics(ctx context.Context, request operations.GetMetricsDeprecatedRequest, opts ...operations.Option) (*components.DeprecatedProcessMetricsData, error) {
