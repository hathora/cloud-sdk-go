...
func (s *RoomsV2) GetInfo(ctx context.Context, roomID string, appID *string, opts ...operations.Option) (*components.Room, error) {
...
// Suspend - SuspendRoomV2Deprecated
...
func (s *RoomsV2) Suspend(ctx context.Context, roomID string, appID *string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
