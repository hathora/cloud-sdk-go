...
// GetForProcess - GetLogsForProcess
// Returns a stream of logs for a [process](https://hathora.dev/docs/concepts/hathora-entities#process) using `appId` and `processId`.
func (s *Logs) GetForProcess(ctx context.Context, processID string, appID *string, follow *bool, tailLines *int, opts ...operations.Option) (io.ReadCloser, error) {
...
// Download - DownloadLogForProcess
// Download entire log file for a stopped process.
func (s *Logs) Download(ctx context.Context, processID string, appID *string, opts ...operations.Option) (io.ReadCloser, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
