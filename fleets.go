...
func newFleets(sdkConfig sdkConfiguration) *Fleets {
	return &Fleets{
...
func (s *Fleets) GetAll(ctx context.Context, orgID *string, opts ...operations.Option) (*components.FleetsPage, error) {
...
// GetRegion - GetFleetRegion
// Gets the configuration for a given [fleet](https://hathora.dev/docs/concepts/hathora-entities#fleet) in a region.
func (s *Fleets) GetRegion(ctx context.Context, fleetID string, region components.Region, orgID *string, opts ...operations.Option) (*components.FleetRegion, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// UpdateRegion - UpdateFleetRegion
// Updates the configuration for a given [fleet](https://hathora.dev/docs/concepts/hathora-entities#fleet) in a region.
func (s *Fleets) UpdateRegion(ctx context.Context, fleetID string, region components.Region, fleetRegionConfig components.FleetRegionConfig, orgID *string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Fleets) GetMetrics(ctx context.Context, request operations.GetFleetMetricsRequest, opts ...operations.Option) (*components.FleetMetricsData, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
