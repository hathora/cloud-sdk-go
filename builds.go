...
func newBuilds(sdkConfig sdkConfiguration) *Builds {
	return &Builds{
...
// ListDeprecated - GetBuildsDeprecated
// Returns an array of [builds](https://hathora.dev/docs/concepts/hathora-entities#build) for an [application](https://hathora.dev/docs/concepts/hathora-entities#application).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) ListDeprecated(ctx context.Context, appID *string, opts ...operations.Option) ([]components.Build, error) {
...
// GetInfo - GetBuildInfoDeprecated
// Get details for a [build](https://hathora.dev/docs/concepts/hathora-entities#build).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) GetInfo(ctx context.Context, buildID int, appID *string, opts ...operations.Option) (*components.Build, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// DeleteDeprecated - DeleteBuildDeprecated
// Delete a [build](https://hathora.dev/docs/concepts/hathora-entities#build). All associated metadata is deleted.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) DeleteDeprecated(ctx context.Context, buildID int, appID *string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// List - GetBuildsV2Deprecated
// Returns an array of [builds](https://hathora.dev/docs/concepts/hathora-entities#build) for an [application](https://hathora.dev/docs/concepts/hathora-entities#application).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) List(ctx context.Context, appID *string, opts ...operations.Option) ([]components.Build, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// CreateMultipart - CreateWithMultipartUploadsV2Deprecated
// Creates a new [build](https://hathora.dev/docs/concepts/hathora-entities#build) with optional `multipartUploadUrls` that can be used to upload larger builds in parts before calling `runBuild`. Responds with a `buildId` that you must pass to [`RunBuild()`](https://hathora.dev/api#tag/BuildV1/operation/RunBuild) to build the game server artifact. You can optionally pass in a `buildTag` to associate an external version with a build.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) CreateMultipart(ctx context.Context, createMultipartBuildParams components.CreateMultipartBuildParams, appID *string, opts ...operations.Option) (*components.BuildWithMultipartUrls, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Delete - DeleteBuildV2Deprecated
// Delete a [build](https://hathora.dev/docs/concepts/hathora-entities#build). All associated metadata is deleted.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) Delete(ctx context.Context, buildID int, appID *string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Get - GetBuild
// Get details for a [build](https://hathora.dev/docs/concepts/hathora-entities#build).
func (s *Builds) Get(ctx context.Context, buildID string, orgID *string, opts ...operations.Option) (*components.BuildV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Run - RunBuildDeprecated
// Builds a game server artifact from a tarball you provide. Pass in the `buildId` generated from [`CreateBuild()`](https://hathora.dev/api#tag/BuildV1/operation/CreateBuild).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Builds) Run(ctx context.Context, buildID int, requestBody operations.RunBuildDeprecatedRequestBody, appID *string, opts ...operations.Option) (*string, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
