...
func newBuildsV1(sdkConfig sdkConfiguration) *BuildsV1 {
	return &BuildsV1{
		sdkConfiguration: sdkConfig,
	}
}

// CreateDeprecated - CreateBuildDeprecated
// Creates a new [build](https://hathora.dev/docs/concepts/hathora-entities#build). Responds with a `buildId` that you must pass to [`RunBuild()`](https://hathora.dev/api#tag/BuildV1/operation/RunBuild) to build the game server artifact. You can optionally pass in a `buildTag` to associate an external version with a build.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *BuildsV1) CreateDeprecated(ctx context.Context, createBuildParams components.CreateBuildParams, appID *string, opts ...operations.Option) (*components.Build, error) {
