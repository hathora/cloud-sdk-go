...
// Create - CreateLobbyDeprecated
// Create a new lobby for an [application](https://hathora.dev/docs/concepts/hathora-entities#application). A lobby object is a wrapper around a [room](https://hathora.dev/docs/concepts/hathora-entities#room) object. With a lobby, you get additional functionality like configuring the visibility of the room, managing the state of a match, and retrieving a list of public lobbies to display to players.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *LobbiesV2) Create(ctx context.Context, security operations.CreateLobbyDeprecatedSecurity, createLobbyParams components.CreateLobbyParams, appID *string, roomID *string, opts ...operations.Option) (*components.Lobby, error) {
...
// GetInfo - GetLobbyInfo
// Get details for a lobby.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *LobbiesV2) GetInfo(ctx context.Context, roomID string, appID *string, opts ...operations.Option) (*components.Lobby, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
