...
func (s *Tokens) GetOrg(ctx context.Context, orgID string, opts ...operations.Option) (*components.ListOrgTokens, error) {
...
// Create - CreateOrgToken
// Create a new organization token.
func (s *Tokens) Create(ctx context.Context, orgID string, createOrgToken components.CreateOrgToken, opts ...operations.Option) (*components.CreatedOrgToken, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// RevokeOrg - RevokeOrgToken
// Revoke an organization token.
func (s *Tokens) RevokeOrg(ctx context.Context, orgID string, orgTokenID string, opts ...operations.Option) (*bool, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
