...
func newBuildsV3(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *BuildsV3 {
	return &BuildsV3{
		rootSDK:          rootSDK,
...
func (s *BuildsV3) CreateBuild(ctx context.Context, createMultipartBuildParams components.CreateMultipartBuildParams, orgID *string, opts ...operations.Option) (*components.CreatedBuildV3WithMultipartUrls, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "401", "404", "408", "422", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
...
func (s *BuildsV3) CreateBuildRegistry(ctx context.Context, createBuildV3Params components.CreateBuildV3Params, orgID *string, opts ...operations.Option) (*components.BuildV3, error) {
	request := operations.CreateBuildRegistryRequest{
		OrgID:               orgID,
		CreateBuildV3Params: createBuildV3Params,
	}

	globals := operations.CreateBuildRegistryGlobals{
		OrgID: s.sdkConfiguration.Globals.OrgID,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/builds/v3/builds/registry")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CreateBuildV3Params", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *BuildsV3) RunBuildRegistry(ctx context.Context, buildID string, registryConfig components.RegistryConfig, orgID *string, opts ...operations.Option) (io.ReadCloser, error) {
	request := operations.RunBuildRegistryRequest{
		BuildID:        buildID,
		OrgID:          orgID,
		RegistryConfig: registryConfig,
	}

	globals := operations.RunBuildRegistryGlobals{
		OrgID: s.sdkConfiguration.Globals.OrgID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/builds/v3/builds/{buildId}/runRegistry", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "RegistryConfig", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
