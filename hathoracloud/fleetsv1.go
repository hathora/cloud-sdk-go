...
// FleetsV1 - Operations to manage and view a [fleet](https://hathora.dev/docs/concepts/hathora-entities#fleet).
type FleetsV1 struct {
	rootSDK          *HathoraCloud
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newFleetsV1(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *FleetsV1 {
	return &FleetsV1{
		rootSDK:          rootSDK,
...
func (s *FleetsV1) GetFleetDeprecated(ctx context.Context, fleetID string, orgID *string, opts ...operations.Option) (*components.Fleet, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/fleets/v1/fleets/{fleetId}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
...
func (s *FleetsV1) GetFleetMetricsDeprecated(ctx context.Context, request operations.GetFleetMetricsDeprecatedRequest, opts ...operations.Option) (*components.FleetMetricsData, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/fleets/v1/fleets/{fleetId}/metrics", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
