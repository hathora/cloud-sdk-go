...
func newLogsV1(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *LogsV1 {
	return &LogsV1{
		rootSDK:          rootSDK,
...
func (s *LogsV1) GetLogsForProcess(ctx context.Context, processID string, appID *string, follow *bool, tailLines *int, opts ...operations.Option) (io.ReadCloser, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "401", "404", "408", "410", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
...
func (s *LogsV1) DownloadLogForProcess(ctx context.Context, processID string, appID *string, opts ...operations.Option) (io.ReadCloser, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "401", "404", "408", "410", "429", "4XX", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
