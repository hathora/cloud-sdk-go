...
func newRoomsV2(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *RoomsV2 {
	return &RoomsV2{
		rootSDK:          rootSDK,
...
func (s *RoomsV2) GetConnectionInfo(ctx context.Context, roomID string, appID *string, opts ...operations.Option) (*components.ConnectionInfoV2, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "402", "404", "408", "422", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
...
func (s *RoomsV2) ResumeRoom(ctx context.Context, roomID string, appID *string, opts ...operations.Option) (*components.RoomAllocationData, error) {
	...
	globals := operations.ResumeRoomGlobals{
		AppID: s.sdkConfiguration.Globals.AppID,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.RoomAllocationData
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
