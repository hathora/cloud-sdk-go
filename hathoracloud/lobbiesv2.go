...
func newLobbiesV2(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *LobbiesV2 {
	return &LobbiesV2{
		rootSDK:          rootSDK,
...
func (s *LobbiesV2) ListActivePublicLobbiesDeprecatedV2(ctx context.Context, appID *string, region *components.Region, opts ...operations.Option) ([]components.Lobby, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"401", "408", "429", "4XX", "5XX"}, httpRes.StatusCode) {
			_httpRes, err := s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, httpRes, nil)
			if err != nil {
				return nil, err
			} else if _httpRes != nil {
