...
<!-- UsageSnippet language="go" operationID="GetFleetRegion" method="get" path="/fleets/v2/fleets/{fleetId}/regions/{region}" -->
```go
package main
...
func main() {
    ...
    res, err := s.FleetsV2.GetFleetRegion(ctx, "<id>", components.RegionSingapore)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
<!-- UsageSnippet language="go" operationID="GetFleetMetrics" method="get" path="/fleets/v2/fleets/{fleetId}/metrics" -->
```go
package main
...
func main() {
    ...
    res, err := s.FleetsV2.GetFleetMetrics(ctx, operations.GetFleetMetricsRequest{
        FleetID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
<!-- UsageSnippet language="go" operationID="GetFleetRegionMetrics" method="get" path="/fleets/v2/fleets/{fleetId}/regions/{region}/metrics" -->
```go
package main
...
func main() {
    ...
    res, err := s.FleetsV2.GetFleetRegionMetrics(ctx, operations.GetFleetRegionMetricsRequest{
        FleetID: "<id>",
