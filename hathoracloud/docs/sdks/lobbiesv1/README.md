...
func main() {
    ...
    }, hathoracloud.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), nil, hathoracloud.Bool(false))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.LobbiesV1.ListActivePublicLobbiesDeprecatedV1(ctx, hathoracloud.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), hathoracloud.Bool(false), nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
