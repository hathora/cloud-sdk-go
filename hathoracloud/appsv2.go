...
// AppsV2 - Operations that allow you manage your [applications](https://hathora.dev/docs/concepts/hathora-entities#application).
type AppsV2 struct {
...
func newAppsV2(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AppsV2 {
	return &AppsV2{
		rootSDK:          rootSDK,
...
func (s *AppsV2) GetApps(ctx context.Context, orgID *string, opts ...operations.Option) (*components.ApplicationsPage, error) {
	...
	globals := operations.GetAppsGlobals{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ApplicationsPage
...
func (s *AppsV2) UpdateApp(ctx context.Context, appConfigWithServiceConfig components.AppConfigWithServiceConfig, appID *string, opts ...operations.Option) (*components.Application, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "AppConfigWithServiceConfig", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *AppsV2) PatchApp(ctx context.Context, partialAppConfigWithServiceConfig components.PartialAppConfigWithServiceConfig, appID *string, opts ...operations.Option) (*components.Application, error) {
	request := operations.PatchAppRequest{
		AppID:                             appID,
		PartialAppConfigWithServiceConfig: partialAppConfigWithServiceConfig,
	}

	globals := operations.PatchAppGlobals{
		AppID: s.sdkConfiguration.Globals.AppID,
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PartialAppConfigWithServiceConfig", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
