...
// ProcessesV1 - Deprecated. Use [ProcessesV3](https://hathora.dev/api#tag/ProcessesV3).
type ProcessesV1 struct {
	rootSDK          *HathoraCloud
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newProcessesV1(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ProcessesV1 {
	return &ProcessesV1{
		rootSDK:          rootSDK,
...
func (s *ProcessesV1) GetProcessInfoDeprecated(ctx context.Context, processID string, appID *string, opts ...operations.Option) (*components.Process, error) {
	...
	globals := operations.GetProcessInfoDeprecatedGlobals{
		AppID: s.sdkConfiguration.Globals.AppID,
	}
