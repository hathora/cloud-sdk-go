...
func (s *FleetsV2) UpdateFleetRegion(ctx context.Context, fleetID string, region components.Region, fleetRegionConfig components.FleetRegionConfig, orgID *string, opts ...operations.Option) error {
