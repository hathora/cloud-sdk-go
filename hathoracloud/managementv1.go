...
func newManagementV1(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ManagementV1 {
	return &ManagementV1{
		rootSDK:          rootSDK,
...
func (s *ManagementV1) SendVerificationEmail(ctx context.Context, request components.VerificationEmailRequest, opts ...operations.Option) (*components.VerificationEmailSuccess, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"401", "408", "429", "4XX", "500", "5XX"}, httpRes.StatusCode) {
