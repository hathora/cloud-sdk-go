...
// MetricsV1 - Deprecated. Use [ProcessesV3#GetProcessMetrics](https://hathora.dev/api#tag/ProcessesV3/operation/GetProcessMetrics) to fetch metrics about a specific process.
...
func newMetricsV1(rootSDK *HathoraCloud, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MetricsV1 {
	return &MetricsV1{
		rootSDK:          rootSDK,
...
func (s *MetricsV1) GetMetricsDeprecated(ctx context.Context, request operations.GetMetricsDeprecatedRequest, opts ...operations.Option) (*components.DeprecatedProcessMetricsData, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeprecatedProcessMetricsData
