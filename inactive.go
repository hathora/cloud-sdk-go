...
func newInactive(sdkConfig sdkConfiguration) *Inactive {
	return &Inactive{
		sdkConfiguration: sdkConfig,
	}
}

// ListForProcess - GetInactiveRoomsForProcess
...
func (s *Inactive) ListForProcess(ctx context.Context, processID string, appID *string, opts ...operations.Option) ([]components.RoomWithoutAllocations, error) {
