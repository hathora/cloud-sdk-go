...
func (s *AppsV2) Update(ctx context.Context, appConfig components.AppConfig, appID *string, opts ...operations.Option) (*components.Application, error) {
...
func (s *AppsV2) Get(ctx context.Context, appID *string, opts ...operations.Option) (*components.Application, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "GetApp",
		SecuritySource: s.sdkConfiguration.Security,
