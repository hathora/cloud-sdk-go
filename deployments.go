...
// GetAll - GetDeploymentsV1Deprecated
// Returns an array of [deployments](https://hathora.dev/docs/concepts/hathora-entities#deployment) for an [application](https://hathora.dev/docs/concepts/hathora-entities#application).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Deployments) GetAll(ctx context.Context, appID *string, opts ...operations.Option) ([]components.DeploymentV1, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out []components.DeploymentV1
...
// Create - CreateDeploymentV1Deprecated
// Create a new [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment). Creating a new deployment means all new rooms created will use the latest deployment configuration, but existing games in progress will not be affected.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Deployments) Create(ctx context.Context, buildID int, deploymentConfig components.DeploymentConfig, appID *string, opts ...operations.Option) (*components.DeploymentV1, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetInfo - GetDeploymentInfoV2Deprecated
// Get details for a [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Deployments) GetInfo(ctx context.Context, deploymentID int, appID *string, opts ...operations.Option) (*components.DeploymentV2, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// CreateDeprecated - CreateDeploymentV2Deprecated
// Create a new [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment). Creating a new deployment means all new rooms created will use the latest deployment configuration, but existing games in progress will not be affected.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Deployments) CreateDeprecated(ctx context.Context, buildID int, deploymentConfigV2 components.DeploymentConfigV2, appID *string, opts ...operations.Option) (*components.DeploymentV2, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Deployments) List(ctx context.Context, appID *string, deploymentTag *string, opts ...operations.Option) (*components.DeploymentsV3Page, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetLatest - GetLatestDeployment
// Get the latest [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment) for an [application](https://hathora.dev/docs/concepts/hathora-entities#application).
func (s *Deployments) GetLatest(ctx context.Context, appID *string, opts ...operations.Option) (*components.DeploymentV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Get - GetDeployment
// Get details for a [deployment](https://hathora.dev/docs/concepts/hathora-entities#deployment).
func (s *Deployments) Get(ctx context.Context, deploymentID string, appID *string, opts ...operations.Option) (*components.DeploymentV3, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
