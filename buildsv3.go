...
func (s *BuildsV3) List(ctx context.Context, orgID *string, opts ...operations.Option) (*components.BuildsV3Page, error) {
...
func (s *BuildsV3) Create(ctx context.Context, createMultipartBuildParams components.CreateMultipartBuildParams, orgID *string, opts ...operations.Option) (*components.CreatedBuildV3WithMultipartUrls, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *BuildsV3) Remove(ctx context.Context, buildID string, orgID *string, opts ...operations.Option) (*components.DeletedBuild, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
