...
// Get - GetBalance
func (s *Billing) Get(ctx context.Context, orgID *string, opts ...operations.Option) (*float64, error) {
...
// GetUpcomingItems - GetUpcomingInvoiceItems
func (s *Billing) GetUpcomingItems(ctx context.Context, orgID *string, opts ...operations.Option) (*components.InvoiceItemPage, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetUpcomingTotal - GetUpcomingInvoiceTotal
func (s *Billing) GetUpcomingTotal(ctx context.Context, orgID *string, opts ...operations.Option) (*operations.GetUpcomingInvoiceTotalResponseBody, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetPaymentMethod
func (s *Billing) GetPaymentMethod(ctx context.Context, orgID *string, opts ...operations.Option) (*components.PaymentMethod, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Billing) InitStripeCustomerPortalURL(ctx context.Context, customerPortalURL components.CustomerPortalURL, orgID *string, opts ...operations.Option) (*string, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetInvoices
func (s *Billing) GetInvoices(ctx context.Context, orgID *string, opts ...operations.Option) ([]components.Invoice, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
