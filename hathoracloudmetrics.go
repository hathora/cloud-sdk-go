...
type HathoraCloudMetrics struct {
	sdkConfiguration sdkConfiguration
}

func newHathoraCloudMetrics(sdkConfig sdkConfiguration) *HathoraCloudMetrics {
	return &HathoraCloudMetrics{
		sdkConfiguration: sdkConfig,
	}
}

// Get - GetProcessMetrics
func (s *HathoraCloudMetrics) Get(ctx context.Context, request operations.GetProcessMetricsRequest, opts ...operations.Option) (*components.ProcessMetricsData, error) {
