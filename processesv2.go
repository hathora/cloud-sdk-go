...
// CountProcesses - GetProcessesCountExperimentalV2Deprecated
...
func (s *ProcessesV2) CountProcesses(ctx context.Context, appID *string, status []components.ProcessStatus, region []components.Region, opts ...operations.Option) (*operations.GetProcessesCountExperimentalV2DeprecatedResponseBody, error) {
...
// CreateProcess - CreateProcessV2Deprecated
...
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *ProcessesV2) CreateProcess(ctx context.Context, region components.Region, appID *string, opts ...operations.Option) (*components.ProcessV2, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
