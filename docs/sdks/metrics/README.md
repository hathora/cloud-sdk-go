...
* [~~GetProcessMetrics~~](#getprocessmetrics) - GetMetricsDeprecated :warning: **Deprecated**
...
func main() {
    ...
    res, err := s.Metrics.GetProcessMetrics(ctx, operations.GetMetricsDeprecatedRequest{
