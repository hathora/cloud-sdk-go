...
* [~~ListRunning~~](#listrunning) - GetRunningProcesses :warning: **Deprecated**
* [~~GetStopped~~](#getstopped) - GetStoppedProcesses :warning: **Deprecated**
* [~~GetInfo~~](#getinfo) - GetProcessInfoV2Deprecated :warning: **Deprecated**
* [~~ListLatest~~](#listlatest) - GetLatestProcessesV2Deprecated :warning: **Deprecated**
* [~~Stop~~](#stop) - StopProcessV2Deprecated :warning: **Deprecated**
* [GetLatest](#getlatest) - GetLatestProcesses
* [Count](#count) - GetProcessesCountExperimental
* [Create](#create) - CreateProcess
* [Get](#get) - GetProcess
...
func main() {
    ...
    res, err := s.Processes.ListRunning(ctx, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Processes.GetStopped(ctx, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Processes.GetInfo(ctx, "cbfcddd2-0006-43ae-996c-995fff7bed2e", cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Processes.ListLatest(ctx, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    err := s.Processes.Stop(ctx, "cbfcddd2-0006-43ae-996c-995fff7bed2e", cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
}
...
func main() {
    ...
    res, err := s.Processes.GetLatest(ctx, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Processes.Count(ctx, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"), nil, nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Processes.Create(ctx, components.RegionSaoPaulo, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Processes.Get(ctx, "cbfcddd2-0006-43ae-996c-995fff7bed2e", cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
