...
* [GetInfo](#getinfo) - GetRoomInfo
* [~~Suspend~~](#suspend) - SuspendRoomV2Deprecated :warning: **Deprecated**
...
func main() {
    ...
    res, err := s.RoomsV2.GetInfo(ctx, "2swovpy1fnunu", cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    err := s.RoomsV2.Suspend(ctx, "2swovpy1fnunu", cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
}
