...
* [LoginWithNickname](#loginwithnickname) - LoginNickname
...
func main() {
    ...
    res, err := s.Auth.LoginAnonymous(ctx, cloudsdkgo.String("app-af469a92-5b45-4565-b3c4-b79878de67d2"))
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Auth.LoginWithNickname(ctx, components.NicknameObject{
...
func main() {
    ...
    res, err := s.Auth.LoginGoogle(ctx, components.GoogleIDTokenObject{
