...
// List - GetAppsV1Deprecated
// Returns an unsorted list of your organization’s [applications](https://hathora.dev/docs/concepts/hathora-entities#application). An application is uniquely identified by an `appId`.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Apps) List(ctx context.Context, opts ...operations.Option) ([]components.ApplicationWithLatestDeploymentAndBuildDeprecated, error) {
...
// CreateDeprecated - CreateAppV1Deprecated
// Create a new [application](https://hathora.dev/docs/concepts/hathora-entities#application).
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Apps) CreateDeprecated(ctx context.Context, request components.AppConfig, opts ...operations.Option) (*components.Application, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Update - UpdateAppV1Deprecated
// Update data for an existing [application](https://hathora.dev/docs/concepts/hathora-entities#application) using `appId`.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Apps) Update(ctx context.Context, appConfig components.AppConfig, appID *string, opts ...operations.Option) (*components.Application, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetInfo - GetAppInfoV1Deprecated
// Get details for an [application](https://hathora.dev/docs/concepts/hathora-entities#application) using `appId`.
//
// Deprecated method: This will be removed in a future release, please migrate away from it as soon as possible.
func (s *Apps) GetInfo(ctx context.Context, appID *string, opts ...operations.Option) (*components.Application, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// GetAll - GetApps
// Returns an unsorted list of your organization’s [applications](https://hathora.dev/docs/concepts/hathora-entities#application). An application is uniquely identified by an `appId`.
func (s *Apps) GetAll(ctx context.Context, orgID *string, opts ...operations.Option) (*components.ApplicationsPage, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
		OperationID:    "GetApps",
		SecuritySource: s.sdkConfiguration.Security,
...
// Create - CreateApp
// Create a new [application](https://hathora.dev/docs/concepts/hathora-entities#application).
func (s *Apps) Create(ctx context.Context, appConfig components.AppConfig, orgID *string, opts ...operations.Option) (*components.Application, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Apps) Delete(ctx context.Context, appID *string, opts ...operations.Option) error {
	hookCtx := hooks.HookContext{
		Context:        ctx,
